...
import com.travel.dx.godaxing.modules.me.util.CodeParse;
...
public class CodeDao {
     ...
     * 请求游戏列表的数据
     */
    public static void requestCode(String mobile, final BaseCallBack callBack)
    {
        HashMap<String, String> params = new HashMap<>();
        params.put("mobile", mobile);
        HttpUtil.doHttpReqeust("GET",
                "http://dxlv.iyoudaxing.com/Api/User/getSmsCode?", params,
                new BaseCallBack()
                {
                    @Override
                    public void success(Object data)
                    {
                        ...
                        if (callBack != null)
                        {
                            LoginInfo temp = CodeParse.parseCode(data.toString());
