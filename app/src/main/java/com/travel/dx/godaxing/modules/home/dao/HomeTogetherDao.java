...
import com.travel.dx.godaxing.modules.home.util.HomeTogetherParse;
...
public class HomeTogetherDao {
    ...
    public static void requestTogetherList(int page, final BaseCallBack callBack)
    {
        ...
        HttpUtil.doHttpReqeust("GET",
                "http://dxlv.iyoudaxing.com/Api/Play/getList/page/?", params,
                new BaseCallBack()
                {
                    @Override
                    public void success(Object data)
                    {
                        ...
                        if (callBack != null)
                        {
                            List<HomeDetailsInfo.DataBean> tempList= HomeTogetherParse.parseHomeDetails(data.toString());
