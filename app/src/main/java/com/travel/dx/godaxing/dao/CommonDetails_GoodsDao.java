...
import com.travel.dx.godaxing.util.CommonDetails_GoodsParse;
 ...
 */
public class CommonDetails_GoodsDao {
        ...
        HttpUtil.doHttpReqeust("GET",
                ...
                new BaseCallBack()
                {
                    ...
                    public void success(Object data)
                    {
                        ...
                        if (callBack != null)
                        {
                            List<CommonDetailsInfo.DataBean.GoodsBean> tempList=  CommonDetails_GoodsParse.parseShopDetails(data.toString());
