...
import com.travel.dx.godaxing.modules.home.dao.PhotoCommendDao;
 ...
 */
public class PhotoCommendFragment extends BaseFragment {
...
// TODO 填充数据(positoin为行数)
    ...
    protected void loadData() {
        PhotoCommendDao.requestPhotoList(page, new BaseCallBack() {
            @Override
