 ...
 */
public class YueJiCardSightDao {
    public static void requestYueJiCardSightList(final BaseCallBack baseCallBack) {
        ...
        HttpUtil.doHttpReqeust("POST",
                ...
                new BaseCallBack()
                {
                    ...
                    public void success(Object data)
                    {
                        ...
                        {
                            List<YueJiCardInfo.DataBean.SightBean> tempList=  YueJiCardParse.YueJiCardSight(data.toString());
