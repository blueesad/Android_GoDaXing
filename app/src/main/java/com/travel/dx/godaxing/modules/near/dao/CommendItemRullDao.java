...
import com.travel.dx.godaxing.modules.near.util.CommendItemRullParse;
 ...
 */
public class CommendItemRullDao {
        ...
        HttpUtil.doHttpReqeust("GET",
                ...
                new BaseCallBack()
                {
                    ...
                    public void success(Object data)
                    {
                        ...
                        if (callBack != null)
                        {
                            List<CommendItemInfo.DataBean.ImagesBean> tempList=  CommendItemRullParse.parseCommendItem(data.toString());
