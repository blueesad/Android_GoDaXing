 ...
 */
public class PastCampaignframent extends BaseFragment {
    ...
    protected void findViews(View view) {
        ...
        listView = (ListView) view.findViewById(R.id.campaign_lv);
            ...
            public void fillData(ViewHolder helper, int position, PlayTogeInfo item) {
                // TODO 填充数据
                    ...
                    helper.setText(R.id.activity_time, start + "-" + end);
                        ...
                        helper.setText(R.id.baoming, "活动已结束 ");
...
//       salecount  shelves
        ...
        PlaytogetherDao.requestPlaytogertherinprogressList( page,new BaseCallBack() {
            ...
            public void success(Object data) {
                ...
                for (int i = 0; i < tempList.size() ; i++) {
                    if (tempList.get(i).getStock()<=0){
                        Log.i("pastnewtempListi", "success: "+i);
    ...
    protected int setLayoutId() {
        return R.layout.activity_past_campaign;
    }
}
